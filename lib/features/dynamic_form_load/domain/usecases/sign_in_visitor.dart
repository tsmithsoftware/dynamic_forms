...
class SignInVisitor extends UseCase<SignInVisitorResponseModel, SignInVisitorParams> {
  final ChecksPageRepository repository;

  SignInVisitor(this.repository);

  @override
  Future<Either<Failure, SignInVisitorResponseModel>> call(SignInVisitorParams params) async {
